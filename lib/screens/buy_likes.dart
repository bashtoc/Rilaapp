...
class BuyLikes extends StatefulWidget {
  const BuyLikes({Key? key}) : super(key: key);
  ...
  @override
  _BuyLikesState createState() => _BuyLikesState();
}
...
class _BuyLikesState extends State<BuyLikes> {
  @override
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Buy real and authentic likes for your  social media platforms.', style: styler,),
              Text(
                'We do not allow Bots or fake accounts, you will get real likes.', style: styler,),
              Text(
                'Users from our database are allocated to like your post or page.', style: styler,),
              const SizedBox(
                height: 10,
              ),
              Row(
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'please select the social media platform where you want likes'),
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'You can target the kind of people you want to like your post by religion, you can select all religion for everyone'),
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'You can target the gender of people you want to like your posts or select all gender for everyone'),
              ...
              RichText(
                text: const TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                        text:
                        'You can target the kind of people you want to like your post by location, you can select a particular state or all Nigerians for everyone'),
                ...
                children: [
                  TextFormField(
                      ...
                      decoration: ktextfield.copyWith(
                        ...
                        labelText: 'Enter your social media post Url or link',
                        hintText: 'Enter your social media post Url or link?',
                        focusedBorder: const OutlineInputBorder(
                          borderSide:
                          BorderSide(color: Color(0xffC55E14), width: 1.0),
                        ),
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'please enter your social media post or page url or link, make sure you copy it with https://'),
