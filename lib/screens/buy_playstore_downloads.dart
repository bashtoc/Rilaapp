...
class BuyGooglePlayReview extends StatefulWidget {
  const BuyGooglePlayReview({Key? key}) : super(key: key);

  @override
  _BuyGooglePlayReviewState createState() => _BuyGooglePlayReviewState();
}
int? followNumber;
int? amount;
...
String dropDownValue = 'Google PlayStore';
var items = [
  'Google PlayStore',
];
...
String tweeter = 'assets/playstore.png';


class _BuyGooglePlayReviewState extends State<BuyGooglePlayReview> {
  @override
            ...
            children: [
              ...
              TextFormField(
                  ...
                  decoration: ktextfield.copyWith(
                    labelText: 'how many downloads do you want?',
                    hintText: 'how many downloads do you want?',
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'This feature is only available on playstore platform'),
