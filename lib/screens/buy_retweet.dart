...
class BuyRetweets extends StatefulWidget {
  const BuyRetweets({Key? key}) : super(key: key);

  @override
  _BuyRetweetsState createState() => _BuyRetweetsState();
}
int? followNumber;
int? amount;
...
class _BuyRetweetsState extends State<BuyRetweets> {
  @override
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Buy real and authentic retweets for your twitter posts.', style: styler,),
              ...
              TextFormField(
                  ...
                  decoration: ktextfield.copyWith(
                    labelText: 'how many Retweets do you want?',
                    hintText: 'how many Retweets do you want?',
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'please select the social media platform where you want Retweets'),
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'You can target the kind people you want to retweet your post by religion, you can select all religion for everyone'),
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'You can target the gender of people you want to retweet your post or select all gender for everyone'),
              ...
              RichText(
                text: const TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                        text:
                        'You can target the kind of people you want to retweet your post by location, you can select a particular state or all Nigerians for everyone'),
