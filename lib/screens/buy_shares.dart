...
class BuyShares extends StatefulWidget {
  const BuyShares({Key? key}) : super(key: key);
...
String tweeter = 'assets/facebook.png';
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Buy real and authentic Nigerian facebook shares for your facebook posts or page.', style: styler,),
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'please select the social media platform where you want shares'),
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'You can target the kind people you want to share your post by religion, you can select all religion for everyone'),
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'You can target the gender of people you want to share your post or select all gender for everyone'),
              ...
              RichText(
                text: const TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                        text:
                        'You can target the kind of people you want to share your post by location, you can select a particular state or all Nigerians for everyone'),
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'please enter your page url or link, make sure you copy it with https://'),
