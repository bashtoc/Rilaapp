...
class BuyFollowers extends StatefulWidget {
  const BuyFollowers({Key? key}) : super(key: key);
  ...
  @override
  _BuyFollowersState createState() => _BuyFollowersState();
}




class _BuyFollowersState extends State<BuyFollowers> {
  int? followNumber;
  int? amount;
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
               Text(
                  'Buy real and authentic Nigerian followers for your social media platforms.', style: styler,),
               Text(
                  'We do not allow Bots or fake accounts, you will get real followers.', style: styler,),
               Text(
                  'Users from our database are allocated to follow your page.', style: styler,),
              const SizedBox(
                height: 10,
              ),
              Row(
              ...
              TextFormField(
                  ...
                  decoration: ktextfield.copyWith(
                    labelText: 'how many followers do you want?',
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'please select the social media platform where you want followers'),
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'You can target the kind of followers you want by religion, you can select all religion for everyone'),
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'You can target the gender of followers you want by or select all gender for everyone'),
              ...
              RichText(
                text: const TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                        text:
                        'You can target the kind of followers you want by location, you can select a particular state or all Nigerians for everyone'),
                ...
                children: [
                  TextFormField(
                      ...
                      decoration: ktextfield.copyWith(
                        ...
                        labelText: 'Enter your social media page Url or link',
                        hintText: 'Enter your social media page Url or link?',
                        focusedBorder: const OutlineInputBorder(
                          borderSide:
                          BorderSide(color: Color(0xffC55E14), width: 1.0),
                        ),
                  ...
                  RichText(
                    text: const TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                            text:
                            'please enter your social media page url or link, make sure you copy it with https://'),
